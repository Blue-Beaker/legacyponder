...
public class PonderRecipeRegistry {
    ...
    private static void addWrapper(IJeiHelpers jeiHelpers, String key, String summary, Entry internal, List<UnconfusionRecipeWrapper> recipes) {
        FontRenderer fr = Minecraft.getMinecraft().fontRenderer;

        List<String> lines = RenderUtils.listFormattedStringToWidth(fr,I18n.format(summary), UnconfusionRecipeCategory.recipeWidth-8);
        // Compute max lines
