...
@ModZenRegister
@ZenClass("mods.legacyponder.IIngredientLink")
public class IIngredientLink {
    public final IngredientLink internal;
    public IIngredientLink(IngredientLink internal){
